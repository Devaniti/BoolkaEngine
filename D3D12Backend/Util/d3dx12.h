...
struct CD3DX12_DEPTH_STENCIL_DESC : public D3D12_DEPTH_STENCIL_DESC
{
    ...
    explicit CD3DX12_DEPTH_STENCIL_DESC(
        ...
        D3D12_STENCIL_OP backStencilPassOp, D3D12_COMPARISON_FUNC backStencilFunc) noexcept
    {
...
struct CD3DX12_SUBRESOURCE_FOOTPRINT : public D3D12_SUBRESOURCE_FOOTPRINT
{
    ...
    CD3DX12_SUBRESOURCE_FOOTPRINT(DXGI_FORMAT format, UINT width, UINT height, UINT depth,
                                  UINT rowPitch)
    noexcept
    {
        Format = format;
...
struct CD3DX12_DESCRIPTOR_RANGE : public D3D12_DESCRIPTOR_RANGE
{
    ...
    static inline void Init(
        _Out_ D3D12_DESCRIPTOR_RANGE& range, D3D12_DESCRIPTOR_RANGE_TYPE rangeType,
...
struct CD3DX12_ROOT_PARAMETER : public D3D12_ROOT_PARAMETER
{
    ...
    static inline void InitAsConstants(
        _Out_ D3D12_ROOT_PARAMETER& rootParam, UINT num32BitValues, UINT shaderRegister,
        UINT registerSpace = 0,
        D3D12_SHADER_VISIBILITY visibility = D3D12_SHADER_VISIBILITY_ALL) noexcept
    {
...
struct CD3DX12_DESCRIPTOR_RANGE1 : public D3D12_DESCRIPTOR_RANGE1
{
    ...
    static inline void Init(
        _Out_ D3D12_DESCRIPTOR_RANGE1& range, D3D12_DESCRIPTOR_RANGE_TYPE rangeType,
        UINT numDescriptors, UINT baseShaderRegister, UINT registerSpace = 0,
        D3D12_DESCRIPTOR_RANGE_FLAGS flags = D3D12_DESCRIPTOR_RANGE_FLAG_NONE,
        UINT offsetInDescriptorsFromTableStart = D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND) noexcept
    {
...
struct CD3DX12_RESOURCE_DESC1 : public D3D12_RESOURCE_DESC1
{
        ...
        UINT samplerFeedbackMipRegionDepth = 0) noexcept
    {
        return CD3DX12_RESOURCE_DESC1(
            D3D12_RESOURCE_DIMENSION_TEXTURE2D, alignment, width, height, arraySize, mipLevels,
...
inline void MemcpySubresource(_In_ const D3D12_MEMCPY_DEST* pDest,
                              _In_ const D3D12_SUBRESOURCE_DATA* pSrc, SIZE_T RowSizeInBytes,
                              UINT NumRows, UINT NumSlices) noexcept
{
