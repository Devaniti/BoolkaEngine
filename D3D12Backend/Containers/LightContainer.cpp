...
namespace Boolka
{
    ...
    void LightContainer::UpdateLights()
    {
        ...
        Matrix4x4 proj = Matrix4x4::CalculateProjPerspective(nearZ, farZ, 1.0f, BLK_DEG_TO_RAD(90.0f));
    ...
    void LightContainer::UpdateSun()
    {
        ...
        static const Vector3 worldPos = Vector3(15.0f, 0.0f, 0.0f) - lightDir * (farZ - nearZ) / 2.0f;
        ...
        static const Matrix4x4 proj = Matrix4x4::CalculateProjOrtographic(nearZ, farZ, worldWidth, worldWidth);
