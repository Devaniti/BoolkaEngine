...
namespace Boolka
{
    ...
    class [[nodiscard]] Texture1D : public Texture
    {
    public:
        Texture1D() = default;
        ~Texture1D() = default;
        ...
        bool Initialize(Device& device, D3D12_HEAP_TYPE heapType, UINT64 width, UINT16 mipCount,
        ...
        [[nodiscard]] static size_t GetUploadSize(UINT width, UINT16 mipCount,
                                                  DXGI_FORMAT format,
    ...
    private:
        static D3D12_RESOURCE_DESC FillDesc(UINT64 width, UINT16 mipCount, DXGI_FORMAT format,
